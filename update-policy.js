...
const policy = {
    "custom_resources": [
        {
            "resource_id": "pepper",
            "available_actions": ["create", "read", "updateOwn", "deleteOwn", "deleteAll", "upvote", "deleteOwnUpvote", "overrideOwnership"]
        },
    ],
    "custom_roles": [
        {
    ...
    "custom_scopes": [
        ...
        },
        {
            ...
            "permissions": [
                {
                    "resource_id": "pepper",
                    "actions": ["overrideOwnership", "deleteAll"]
                }
            ]
        },
    ],
